...
$post_show_social      = lezada_get_option( 'post_show_social' );
$post_show_author_info = lezada_get_option( 'post_show_author_info' );
$post_show_related     = lezada_get_option( 'post_show_related' );
...
$sidebar = Lezada_Helper::get_active_sidebar();
