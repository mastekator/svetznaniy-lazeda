...
$product_bgcolor = get_post_meta( Lezada_Helper::get_the_ID(), 'lezada_product_bgcolor', true );
...
if ( get_post_meta( Lezada_Helper::get_the_ID(), 'lezada_product_title_on', true ) == 'on' ) {
...
if ( lezada_get_option( 'product_ajax_add_to_cart' ) ) {
...
add_action( 'woocommerce_after_add_to_cart_button', array( 'Lezada_Woo', 'compare_button' ) );
...
<div id="product-<?php the_ID(); ?>" <?php post_class( $product_class ); ?>>
	...
	<div class="container">
		...
		if ( ! get_post_meta( Lezada_Helper::get_the_ID(), 'lezada_hide_related_products', true ) == 'on' ) {
			woocommerce_output_related_products();
		}
		?>
	</div>
	<?php echo Lezada_Woo::product_instagram(); ?>
