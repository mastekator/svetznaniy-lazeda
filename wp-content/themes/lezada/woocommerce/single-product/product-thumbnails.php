...
$carousel_settings = apply_filters( 'lezada_single_product_thumbnails_carousel_settings',
	array(
		'accessibility' => false,
		'focusOnSelect' => true,
		'variableWidth' => true,
	...
	<div class="thumbnails thumbnails-slider"
		...
		if ( $product_page_layout != 'sticky' && $product_page_layout != 'sticky-fullwidth' ) {
			...
			$html .= get_the_post_thumbnail( $post->ID,
				apply_filters( 'lezada_single_product_large_thumbnail_size', $size ),
				$attributes );
			$html .= '</a>';
		...
		foreach ( $attachment_ids as $attachment_id ) {
			...
			$image_single    = wp_get_attachment_image_src( $attachment_id,
				apply_filters( 'lezada_single_product_large_thumbnail_size', 'woocommerce_single' ) );
			...
			$html .= wp_get_attachment_image( $attachment_id,
				apply_filters( 'lezada_single_product_small_thumbnail_size', $size ),
				false,
				$attributes );
			$html .= '</a>';
