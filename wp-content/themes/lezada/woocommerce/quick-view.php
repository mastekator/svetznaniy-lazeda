...
?>
	...
	<div class="woocommerce single-product">
		...
		<div class="quickview-loading"><span><?php esc_html_e( 'Adding to cart...', 'lezada' ); ?></span></div>
			...
			<div class="row">
				...
				<?php } else { ?>
					<div class="images">
						...
						<?php
						$carousel_settings = apply_filters( 'lezada_quickview_carousel_settings',
							array(
								'accessibility' => false,
								'arrows'        => true,
								'dots'          => true,
						...
						<div class="quick-view-carousel woocommerce-product-gallery__image"
							...
							if ( has_post_thumbnail() ) {
								...
								$image_size = array(
									apply_filters( 'lezada_quickview_image_width',
										intval( get_option( 'shop_single_image_size',
											array( 'width' => 432 ) )['width'] ) * .8 ),
									apply_filters( 'lezada_quickview_image_height',
										intval( get_option( 'shop_single_image_size',
	...
	<script type="text/javascript">
		...
		var wc_single_product_params = <?php echo json_encode( apply_filters( 'wc_single_product_params',
			array(
				'i18n_required_rating_text' => esc_attr__( 'Please select a rating', 'lezada' ),
