...
$pagination = lezada_get_option( 'shop_pagination' );
...
<?php else :
	...
	$load_more_atts = array(
		...
		'post_type'      => 'product',
		'paged'          => 1,
		'posts_per_page' => apply_filters( 'lezada_ajax_products_per_page',
	...
	?>
	<div class="lezada-loadmore-wrap woocommerce-pagination"
	     data-atts="<?php echo esc_attr( json_encode( $load_more_atts ) ); ?>">
		<a href="#"
		   class="button lezada-loadmore-btn load-on-<?php echo '' . ( $pagination == 'more-btn' ) ? 'click' : 'scroll'; ?>"><?php esc_html_e( 'more',
				'lezada' ); ?></a>
	</div>
<?php endif; ?>
