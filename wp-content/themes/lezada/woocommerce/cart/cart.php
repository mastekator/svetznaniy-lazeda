...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
		<thead>
		<tr>
			<th class="product-name" colspan="2"><?php esc_html_e( 'Product', 'lezada' ); ?></th>
			<th class="product-price"><?php esc_html_e( 'Price', 'lezada' ); ?></th>
			<th class="product-quantity"><?php esc_html_e( 'Quantity', 'lezada' ); ?></th>
			<th class="product-subtotal"><?php esc_html_e( 'Total', 'lezada' ); ?></th>
		...
		foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
			...
			if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible',
				...
				<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class',
					...
					<td class="product-name" data-title="<?php esc_html_e( 'Product', 'lezada' ); ?>">
						<?php
						if ( ! $product_permalink ) {
					...
					<td class="product-price" data-title="<?php esc_html_e( 'Price', 'lezada' ); ?>">
						<?php
					...
					<td class="product-quantity" data-title="<?php esc_html_e( 'Quantity', 'lezada' ); ?>">
						<?php
					...
					<td class="product-subtotal" data-title="<?php esc_html_e( 'Total', 'lezada' ); ?>">
						<?php
		...
		<div class="col-sm-12 col-lg-8">
			<?php if ( wc_coupons_enabled() ) { ?>
				<div class="coupon">
					...
					<label for="coupon_code"><?php esc_html_e( 'Coupon:', 'lezada' ); ?></label>
					<input type="text" name="coupon_code" class="input-text" id="coupon_code" value=""
					       placeholder="<?php echo esc_attr_e( 'Enter your coupon code', 'lezada' ); ?>"/>
					<input type="submit" class="button" name="apply_coupon"
					       value="<?php esc_attr_e( 'Apply Coupon', 'lezada' ); ?>"/>
