...
<form class="woocommerce-cart-form" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post">
    ...
    <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
        <thead>
        <tr>
            <th class="product-name" colspan="2"><?php pll_e('Product'); ?></th>
            <th class="product-price"><?php pll_e('Price'); ?></th>
            <th class="product-quantity"><?php pll_e('Quantity'); ?></th>
    ...
    <div class="row cart-actions">
        <div class="col-sm-12 col-lg-8">
            <?php if (wc_coupons_enabled()) { ?>
                <div class="coupon">
                    ...
                    <label for="coupon_code"><?php pll_e('Coupon:'); ?></label>
                    <input type="text" name="coupon_code" class="input-text" id="coupon_code" value=""
                           placeholder="<?php pll_e('Enter your coupon code'); ?>"/>
                    <input type="submit" class="button" name="apply_coupon"
                           value="<?php pll_e('Apply Coupon'); ?>"/>
        ...
        <div class="col-sm-12 col-lg-4">
            <button type="submit" class="button" name="update_cart"><?php pll_e('Update Cart'); ?></button>
