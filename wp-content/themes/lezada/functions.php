...
add_action('init', function () {
    ...
    pll_register_string('js-back', 'Back to top');
    pll_register_string('js-wishlist', 'Browse Wishlist');
    pll_register_string('js-added-to-wishlist', 'Product has been added to wishlist!');
    pll_register_string('js-view-cart', 'View Cart');
    pll_register_string('js-added-to-cart', 'has been added to cart!');
    pll_register_string('js-product-added-to-cart', 'Product has been added to cart!');
    pll_register_string('js-adding', 'Adding to cart...');
