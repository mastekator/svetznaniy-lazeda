...
/**
 * @package   Lezada_Framework
 */

if ( class_exists( 'Walker_Nav_Menu' ) && ! class_exists( 'Lezada_Walker_Nav_Menu' ) ) {

	class Lezada_Walker_Nav_Menu extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( $css ) {
				$js_output = '';
				$js_output .= 'if ( _lezadaInlineStyle !== null ) {';
				$js_output .= '_lezadaInlineStyle.textContent+=\'' . Lezada_Helper::text2line( $css ) . '\';';
				$js_output .= '}';
				wp_add_inline_script( 'lezada-main-js', Lezada_Helper::text2line( $js_output ) );
			}
	...
	add_filter( 'insight_core_bmw_nav_args', 'lezada_add_extra_params_to_insightcore_bmw' );
	function lezada_add_extra_params_to_insightcore_bmw( $args ) {
