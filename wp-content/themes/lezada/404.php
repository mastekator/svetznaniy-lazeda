            ...
            <div class="container">
                <div class="area-404__content row flex-items-xs-middle">
                    <div class="col-xs-12 col-xl-6 col-404">
                        <h1 class="area-404__heading"><?php pll_e('Oops!'); ?></h1>
                        <h1 class="area-404__sub-heading"><?php pll_e('Page not found!'); ?></h1>
                        <p class="area-404__content-heading"><?php pll_e("please go back to "); ?>
                            <a href="<?php echo esc_url(home_url('/')); ?>"
                               class="button 404-button"><?php pll_e('Homepage'); ?></a>
                        </p>
                    </div>
                </div>
            </div>
